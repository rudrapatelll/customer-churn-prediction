...
Originally developed by Meredith Wang and currently maintained by Rudra Patel.
...
- Is tenure shorter for customers who churn?
...
*Payment Type* | 1) Bank transfer 2) Credit card 3) Electronic check 4) Mailed check | This tells us how the customer is paying for the service
*Monthly Charges* | Float number | This tells us how much the customer is paying each month
*Tenure* | Integer ranging from 0-72 | This shows how long (months) the customer stays with the company
...
- Conduct Chi-Square Test for categorical variable vs. categorical variable
...
- [x] Follow instructions in telco_analysis workbook and README file
- [x] Run telco_report
...
- Average monthly charges are higher for customers who churn
...
- Skills: Python, SQL, R, C++, Bash, TensorFlow, PyTorch, Keras
